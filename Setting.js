...
global.owner = process.env.OWNER_NUMBER  || '255688930205' ;  // ADD YOUR NUMBER WITHOUT +
...
global.sudo  =  process.env.SUDO || "255688930205" ;          // DON'T REMOVE
...
global.THUMB_IMAGE = process.env.THUMB_IMAGE || 'https://telegra.ph/file/74542a99a7adcd041675a.png' ;
//=================================================================================
...
module.exports = {
  ...
  botname: process.env.BOT_NAME       || '𝖃𝖍𝖗𝖎𝖘𝖘 𝕸𝖉',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `ƈɦɾιʂʂ ɱɯαɳʝ`, // ADD YOUR NAME
  ...
  //==============================[WHAT'SAPP FEATURES]==============================
  author:  process.env.PACK_AUTHER  || '𝖃𝖍𝖗𝖎𝖘𝖘 𝕸𝖉',      // ADD YOUR STICKER AUTHOR NAME
  ...
  packname:  process.env.PACK_NAME  || "𝖃𝖍𝖗𝖎𝖘𝖘 𝕸𝖉" ,          // ADD YOUR STICKER PACKNAME
  ...
  caption :process.env.CAPTION || "Mr Xhriss Bσтz* ",
